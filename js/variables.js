export const appVariables = {
  ...
  translations: {
    es: {
      ...
      pasos_proceso_datos: "Datos",
      pasos_proceso_certificado: "Certificado",
      pasos_proceso_pago: "Pago",
      pasos_proceso_descarga: "Descarga",
      pasos_elegir_estilo: "Estilo",
      boton_continuar_pago: "Continuar al Pago",
      boton_volver_form: "Volver",
      resumen_pedido: "Resumen de tu pedido",
      resumen_pedido_estrella: "Estrella",
      resumen_pedido_obj_org: "Objeto original",
      resumen_pedido_coord: "Coordenadas",
      resumen_pedido_cert: "Certificado",
      resumen_pedido_total: "Total",
      boton_volver_cert: "Volver a elegir certificado",
      pago_confirmado:"¡Pago confirmado! Tu certificado personalizado está listo.",
      gracias_compra: "¡Gracias por tu compra!",
      validacion_correo: "Ingresa un correo válido.",
    ...
    en: {
      ...
      pasos_proceso_datos: "Details",
      pasos_proceso_certificado: "Certificate",
      pasos_proceso_pago: "Payment",
      pasos_proceso_descarga: "Download",
      pasos_elegir_estilo: "Style",
      boton_continuar_pago: "Proceed to Payment",
      boton_volver_form: "Back",
      resumen_pedido: "Order summary",
      resumen_pedido_estrella: "Star",
      resumen_pedido_obj_org: "Original object",
      resumen_pedido_coord: "Coordinates",
      resumen_pedido_cert: "Certificate",
      resumen_pedido_total: "Total",
      boton_volver_cert: "Go back to choose certificate",
      pago_confirmado:"Payment confirmed! Your personalized certificate is ready.",
      gracias_compra: "Thank you for your purchase!",
      validacion_correo: "Enter a valid email.",
    ...
    pt: {
      ...
      pasos_proceso_datos: "Dados",
      pasos_proceso_certificado: "Certificado",
      pasos_proceso_pago: "Pagamento",
      pasos_proceso_descarga: "Download",
      pasos_elegir_estilo: "Estilo",
      boton_continuar_pago: "Continuar para o Pagamento",
      boton_volver_form: "Retornar",
      resumen_pedido: "Resumo do seu pedido",
      resumen_pedido_estrella: "Estrela",
      resumen_pedido_obj_org: "Objeto original",
      resumen_pedido_coord: "Coordenadas",
      resumen_pedido_cert: "Certificado",
      resumen_pedido_total: "Total",
      boton_volver_cert: "Voltar para escolher o certificado",
      pago_confirmado:"Pagamento confirmado! Seu certificado personalizado está pronto.",
      gracias_compra: "Obrigado pela sua compra!",
      validacion_correo: "Insira um e-mail válido.",
